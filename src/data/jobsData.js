...
export const jobsData = [
...

  {
    ...
    type: "Full-Time",
    location: "On-site (Sector 49, Gurugram)",
    desc: "Join as a Full Stack Engineer Intern to work across frontend and backend tasks for AI, OTT, and digital platforms. Contribute to building responsive web apps, dashboards, and APIs under mentorship.",
    requirements: [
...

  {
    ...
    type: "Full-Time",
    location: "On-site (Sector 49, Gurugram)",
    desc: "Work directly with the AI team to train, optimize, and deploy generative AI models (text, image, video) for real-world applications.",
    requirements: [
...

  {
    ...
    type: "Full-Time",
    location: "On-site (Sector 49, Gurugram)",
    desc: "Drive lead generation, client engagement, and sales growth for IT services and solutions. Engage directly with international clients and coordinate with technical teams to close deals.",
    requirements: [
...

  {
    ...
    type: "Full-Time",
    location: "On-site (Sector 49, Gurugram)",
    desc: "Assist in designing UI/UX flows, wireframes, and mockups for web and mobile applications across global projects.",
    requirements: [
