...
export default function AboutPage() {
  ...
  return (
    <div className="bg-gray-900 py-10 text-white min-h-screen flex flex-col px-4 md:px-8 lg:px-12">
      {/* Header Section */}
      <section className="container mx-auto px-4 md:px-8 lg:px-12 py-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-8 mb-[-58]">
        {/* Text Content */}
      ...
      <section className="py-5 md:py-2 w-full flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 mb-[-18]">
        <div className="container mx-auto px-0 md:px-4 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6" data-aos="fade-up">Our Mission & Vision</h2>
      ...
      {/* Core Values Section */}
      <section className="py-10 md:py-12 w-full px-4 md:px-8 lg:px-12 flex flex-col items-center justify-center mb-[-68]">
