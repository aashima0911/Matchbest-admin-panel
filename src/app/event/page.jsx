...
export default function EventPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      {/* HERO SECTION */}
      <section className="bg-gradient-to-r from-[#130F40] via-[#2C2C54] to-[#1B1464] text-white py-12 md:py-14 px-4 md:px-16 text-center">
        <motion.div variants={fadeInUp} initial="hidden" animate="visible" className="max-w-7xl mx-auto">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold mb-6 py-10">LIVE WEBINAR|MATCHBEST.AI X BYTEPLUS</h1>
          <p className="text-base md:text-lg text-gray-200 mb-4 md:mb-5">
            Unlock next-generation strategies and insights for smarter, faster, AI-driven content creation.
            <br className="hidden md:block"/>Join thought leaders in this exclusive webinar hosted by <span className="text-indigo-400 font-semibold">Matchbest Group × BytePlus</span>.
          </p>
          <p className="text-base md:text-lg text-gray-200 mb-4 md:mb-10">Your 1-hour shortcut to smarter strategies</p>
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLScX2eGiZrmZCjbN1SSPGNYd9_voqLTmlpQOP2yMrMeX5W6ZHg/viewform" target="_blank" rel="noopener noreferrer">
            <button className="bg-indigo-600 hover:bg-indigo-500 px-6 py-3 md:px-8 md:py-4 rounded-full font-semibold text-white shadow-lg transition transform hover:scale-105">
              RSVP Now
            </button>
          </Link>
        </motion.div>
      ...
      <section className="bg-gradient-to-r from-[#F3E5F5] via-[#E1BEE7] to-[#D1C4E9] py-8 md:py-10 px-4 md:px-16">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-800">
      ...
      {/* AGENDA SECTION */}
      <section className="bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] text-white py-10 md:py-14 px-4 md:px-16">
      ...
      {/* CTA SECTION */}
      <section className="bg-gradient-to-r from-[#2E0249] via-[#570A57] to-[#A91079] text-white py-10 md:py-14 text-center">
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" className="max-w-3xl mx-auto">
          ...
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLScX2eGiZrmZCjbN1SSPGNYd9_voqLTmlpQOP2yMrMeX5W6ZHg/viewform" target="_blank" rel="noopener noreferrer">
            <button className="bg-white text-[#2E0249] px-6 py-3 md:px-10 md:py-4 rounded-full font-semibold hover:bg-gray-100 transition transform hover:scale-105 flex items-center mx-auto">
              <IconUsers /> RSVP Now
            </button>
          </Link>
        </motion.div>
