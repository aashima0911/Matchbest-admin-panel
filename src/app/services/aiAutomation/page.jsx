...
import { Headset, Zap, ShieldCheck, TrendingUp } from 'lucide-react'

const developmentFeatures = [
  "Deploy advanced chatbots and voice agents that handle customer inquiries with human-like precision and 24/7 availability",
  "Streamline repetitive tasks across departments with smart triggers and cross-platform data synchronization",
  "Utilize machine learning models to analyze data patterns and forecast trends before they happen",
  "Harness the power of LLMs to automate content creation, report generation, and personalized marketing",
  "Connect modern AI capabilities with your existing enterprise tools through secure, high-performance APIs"
]

const features = {
  col1: ["24/7 Availability", "Cost Reduction", "Enhanced CX", "Rapid Scalability"],
  col2: ["Cost Efficiency", "Real-Time Data", "Improved Productivity", "High Availability"],
  col3: ["Human-Error Elimination", "Adaptive Learning", "Global Language Support", "Measurable ROI"]
};

const capabilities = [
  {
    title: "Conversational Intelligence & NLP",
    desc: "Deploy human-like AI agents capable of understanding complex intent, sentiment, and context. Our systems support multi-language interactions and provide instant, accurate responses across all customer touchpoints.",
    points: ["NLP", "Multi-Language Support", "Context awareness", "Seamless handoff"]
  },
  {
    title: "Autonomous Workflow Orchestration",
    desc: "Streamline end-to-end business processes with intelligent triggers that connect your entire tech stack. We automate repetitive data entry, synchronization, and operational tasks, allowing your team to focus on high-value strategy.",
  ...
  },
  {
    ...
    desc: "Leverage machine learning models to turn raw data into actionable business intelligence. Our solutions monitor performance in real-time, forecasting trends and identifying bottlenecks before they impact your ROI.",
    points: ["Process mapping", "Smart trigger", "Performance analytics", "Continuous optimization"]
  },
  {
    title: "Generative AI & LLM Integration",
    desc: "Harness the power of Large Language Models to automate content generation, specialized reporting, and personalized marketing at scale. We fine-tune models to your specific industry data for maximum accuracy and security.",
...
const useCases = [
  {
    ...
    desc: "We don't just sell tools; we analyze your specific business friction points to design an automation roadmap that delivers actual value.",
    icon: Headset
  },
  {
    title: "Custom Model Training",
    desc: "We build and fine-tune AI models specifically for your data and industry, ensuring higher accuracy than 'off-the-shelf' solutions.",
    icon: Zap
  },
  {
    title: "Security-Centric Deployment",
    desc: "Every automation script is audited for security, ensuring your data privacy is maintained across all automated touchpoints.",
    icon: ShieldCheck
  },
  {
          ...
          <div className="space-y-8 px-4">
            <div className="space-y-4">
              <h1 className="text-2xl md:text-4xl font-normal text-white uppercase">
                <span className="bg-gradient-to-r from-white via-white/80 to-white/20 bg-clip-text text-transparent">AI Automation: Redefining</span> <br />
                <span className="bg-gradient-to-r from-white via-white/80 to-white/20 bg-clip-text text-transparent"> Enterprise Efficiency</span>
              </h1>
              <p className="text-gray-500 dark:text-gray-300 text-lg max-w-[3x1]">
                Empower your business with intelligent workflows, autonomous chatbots, and smart decision-making ecosystems.     
             </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-24 mb-8 md:mb-12">
          ...
          <div className="lg:w-1/3 space-y-8">
            ...
            <p className="text-gray-500 dark:text-gray-300 text-sm md:text-base leading-tight font-light">
                In today's fast-paced digital economy, manual workflows are a bottleneck. At Matchest.ai, we build AI-driven automation solutions that don't just follow rules—they learn, adapt, and optimize your business operations in real-time. From customer experience to backend logistics, we automate the complex so you can focus on growth.
            </p>
          </div>
