...
const SolutionsPage = () => {
  return (
    <div className="bg-black text-white min-h-screen flex flex-col mt-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 ">
        <h1 className="text-4xl md:text-5xl font-['Inter'] font-normal text-center mb-12 text-white">Our Solutions</h1>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col gap-3">
                  <Link
                    href={item.link || "#"}
                    target="_blank"
                    className="text-sm font-bold text-purple-400 border-b border-purple-500 pb-0.5 hover:text-purple-300 hover:border-purple-400 transition-colors"
                  >
                    Learn More →
                  </Link>
                  ...
                  <Link
                    href={item.extraLink}
                    target="_blank"
                    className="text-sm font-semibold text-gray-400 hover:text-purple-400 border-b border-gray-500 hover:border-purple-400 transition-colors flex items-center gap-1"
                  >
