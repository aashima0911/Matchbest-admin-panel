...
const Footer = () => {
  return (
    <footer className="w-full bg-[#090909] pt-3 pb-4 border-t border-white/20">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-12 text-sm text-gray-400 w-full lg:w-auto">
            ...
            {/* Email */}
            <div className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer pb-3 border-b border-white/20 min-w-[150px]">
            ...
            {/* Phone */}
            {/* <div className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer pb-3 border-b border-white/10 min-w-[150px]">
